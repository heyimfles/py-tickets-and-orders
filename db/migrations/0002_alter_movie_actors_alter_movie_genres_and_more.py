    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_session', to='db.moviesession')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_order', to='db.order')),
            ],
            options={
                'constraints': [models.UniqueConstraint(fields=('row', 'seat', 'movie_session'), name='unique_ticket_row_seat_movie')],
            },
        ),
    ]
